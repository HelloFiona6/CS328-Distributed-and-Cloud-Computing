...
class AssistantServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Count = channel.unary_stream(
                '/AssistantService/Count',
                request_serializer=assistant__pb2.CountRequest.SerializeToString,
                response_deserializer=assistant__pb2.CountResponse.FromString,
...
class AssistantServiceServicer(object):
    ...
    def Count(self, request, context):
        """Counts from a given number and adds one every <step> seconds. 
        Report strings are streamed back to the client.
        """
...
def add_AssistantServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Count': grpc.unary_stream_rpc_method_handler(
                    servicer.Count,
                    request_deserializer=assistant__pb2.CountRequest.FromString,
                    response_serializer=assistant__pb2.CountResponse.SerializeToString,
            ),
    }
...
class AssistantService(object):
    ...
    def Count(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/AssistantService/Count',
            assistant__pb2.CountRequest.SerializeToString,
            assistant__pb2.CountResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
